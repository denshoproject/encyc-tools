...
templates = {
    ...
    'Template:Reflist': [
        'Template:Anchor',
        'Template:CSS_list-style-type_values',
        'Template:CSS_list-style-type_values/core',
        'Template:CSS3_multiple_column_layout',
        'Template:Citation/core',
        'Template:Citation/make_link',
        'Template:Cite_web',
        'Template:Clear',
    ...
    'Template:Refbegin': [
        'Template:CSS3_multiple_column_layout',
        'Template:Category_handler',
        'Template:Category_handler/blacklist',
        'Template:Category_handler/numbered',
        'Template:Citation/core',
        'Template:Citation/identifier',
        'Template:Citation/make_link',
        'Template:Cite_book',
        ...
        'Template:Fmbox',
        'Template:Hide_in_print',
        'Template:ISO_639_name_es',
        'Template:If_pagename',
        'Template:Language_icon',
        'Template:Mbox',
